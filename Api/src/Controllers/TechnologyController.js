...
const getTechnologies = async () => {
  ...
  try {
    for (let i = 0; i < tecnologias.length; i++) {
      let [techX, created] = await Technology.findOrCreate({ //findOrcreate, si agregamos una tecnologia existente no la duplique
    ...
    technologies.sort((a, b) => { //ordedenado alfabeticaamente
